...
insert_item_location_window = uic.loadUiType(resource_path("/Users/black/projects/make_erp/insert_item_location.ui"))[0]

#화면을 띄우는데 사용되는 Class 선언
class WindowClass(QMainWindow, insert_item_location_window) :
    def __init__(self) :
        super().__init__()
        self.setupUi(self)
        self.slots()
